...
function SlashCmdList.IWINDRUID(command)
	...
	elseif arguments[1] == "berserkcat" then
        if arguments[2] then IWin_Settings["berserkCat"] = arguments[2] end
		...
		DEFAULT_CHAT_FRAME:AddMessage("|cff0066ff /iwin berserkcat [|r" .. IWin_Settings["berserkCat"] .. "|cff0066ff]:|r Use Berserk in Cat Form.")
    end
end